...
handsUpGesture.addDirection(Finger.Thumb, FingerDirection.HorizontalLeft, 0.25);
handsUpGesture.addDirection(Finger.Thumb, FingerDirection.HorizontalRight, 0.25);
